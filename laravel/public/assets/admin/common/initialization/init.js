$(function() {
    BJUI.init({
        JSPATH       : '/assets/vendor/b-jui/',         //[可选]框架路径
        PLUGINPATH   : '/assets/vendor/b-jui/plugins/', //[可选]插件路径
        loginInfo    : {url: prefix + '/login-timeout', title:'登录', width:440, height:240}, // 会话超时后弹出登录对话框
