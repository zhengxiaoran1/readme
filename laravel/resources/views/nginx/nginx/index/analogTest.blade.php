...
<div class="bjui-row col-2">
    ...
    <div class="bjui-row col-2">
        ...
        <input style="width:40%" type="hidden" name="visitPostParam" value="{{$visitPostParam}}" id="visitPostParam">
        ...
        <textarea style="width:70%;height:130px;" ><?php
            $param = explode('&',urldecode($visitPostParam));
            $newParam = [];
            if($param){

                foreach ($param as $k => $v){
                    $val = explode('=',$v);
                    $newParam[$val[0]] = $val[1];
                }
            }
            echo json_encode($newParam);
            ?></textarea>
