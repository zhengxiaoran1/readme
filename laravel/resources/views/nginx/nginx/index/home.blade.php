@extends('nginx.nginx.index.master')
@section('content')
    ...
    <div class="container_fluid" id="bjui-body">
        ...
        <div id="bjui-navtab" class="tabsPage">
            ...
            {{--toolbarItem: 'add,edit,del,|,import,export,exportf',--}}
                                dataUrl: '/nginx/nginxLogData?callback=?',
                                dataType: 'jsonp',
                                jsonPrefix: '',
                    ...
                    <script>
                        ...
                        function analogTest(value, data){
                            ...
                            var html = '<button type="button" class="btn btn-green" data-toggle="dialog" data-options="{id:\'analog_test_dialog\',width:1300,height:1000,fresh:true,type:\'POST\',url:\'/nginx/analogTest\', title:\'模拟访问\', data:{_token:\'{{csrf_token()}}\',visitUrl:\'' + data.visitUrl + '\',visitGetParam:\'' + data.visitGetParam + '\',visitPostParam:\'' + data.visitPostParam + '\',visitToken:\'' + data.visitToken + '\',visitImei:\'' + data.visitImei + '\',platform:\'' + data.platform + '\',version:\'' + data.version + '\'}}"><i class="fa fa-edit"></i>模拟访问</button>';
